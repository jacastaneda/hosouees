...
use app\modules\catalogs\models\CarreraSearch;
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'content'=>'<span class="text-success">Carrera creada exitosamente</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
